...
<b>Dit hoofdstuk beschrijft en introduceert de het gebruik van het concept ‘data space’ vanuit het perspectief van de Europese Geo-Informatie Infrastructuur (NGII). We belichten het ‘data fundament’, de afspraken over standaarden voor interoperabiliteit, de bouwstenen en voorzieningen in de Europese geo-informatie infrastructuur, die in de afgelopen 15 jaar is gerealiseerd op basis van de Europese INSPIRE Richtlijn.</b>[HOI]<br/>
## De Europese geo-informatie infrastructuur {#7F362A4A}
...
\
<b>De INSPIRE principes</b>[HOI]<br/>
INSPIRE kent een aantal uitgangspunten en principes:[HOI]<br/>
...
<b>De INSPIRE functies</b>[HOI]<br/>
...
\
<b>INSPIRE afsprakenstelsel</b>[HOI]<br/>
...
\
De volgende afspraken maken deel uit van het gehele kwaliteitsraamwerk:[HOI]<br/>
...
\
De negen initiële gemeenschappelijke Europese data spaces zijn de volgende:[HOI]<br/>
1.    Een industriële data space, ter ondersteuning van het concurrentievermogen en de prestaties van de EU-industrie;[HOI]<br/>
2.    Een Green Deal data space, om het grote potentieel van data te gebruiken ter ondersteuning van de prioritaire acties van de Green Deal op het gebied van onderwerpen als klimaatverandering, circulaire economie, milieuvervuiling, biodiversiteit en ontbossing;[HOI]<br/>
3.    Een mobiliteitsdata space, om Europa in de voorhoede te plaatsen bij de ontwikkeling van een intelligent vervoerssysteem;[HOI]<br/>
4.    Een ruimte voor gezondheidsdata, essentieel voor vooruitgang bij het voorkomen, opsporen en behandelen van ziekten en voor geïnformeerde, op feiten gebaseerde beslissingen om de gezondheidszorgstelsels te verbeteren;[HOI]<br/>
5.    Een financiële data space om innovatie, markttransparantie, duurzame financiering, evenals toegang tot financiering voor Europese bedrijven en een meer geïntegreerde markt te stimuleren;[HOI]<br/>
6.    Een energie data space, om een sterkere beschikbaarheid en sector-overschrijdend delen van data te bevorderen, op een klantgerichte, veilige en betrouwbare manier;[HOI]<br/>
7.    Een landbouw data space, om de duurzaamheidsprestaties en het concurrentievermogen van de landbouwsector te verbeteren door de verwerking en analyse van data;[HOI]<br/>
8.    Data spacen voor overheidsdiensten, om de transparantie en verantwoording van de overheidsuitgaven en de kwaliteit van de uitgaven te verbeteren, corruptie te bestrijden, zowel op EU- als op nationaal niveau;[HOI]<br/>
9.    Een data space voor vaardigheden om de discrepanties tussen de onderwijs- en opleidingsstelsels en de behoeften van de arbeidsmarkt te verkleinen.[HOI]<br/>
