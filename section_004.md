...
\
<img src='media/image2.png' alt='Afbeelding met tekst' style='width: 100%;'></img>
...
<i>Bron: [[Scerri]]</i>\
\
“An infrastructure that enables data transactions between different data ecosystem<br/>
parties based on the governance framework of that data space. Data space should be<br/>
...
\
In deze verkenning zijn de volgende data space initiatieven nader beschouwd en uiteengezet via de quick-scan analyse en bezien:<br/>
...
\
De bouwsteen<b> Operationele overeenkomst </b>beschrijft de datadiensten die door een dataprovider worden geleverd, samen met de normen waaraan de levering van de datadiensten moet voldoen. De geleverde datadiensten moeten voldoen aan gespecificeerde normen, terwijl de consument van de diensten het recht heeft om te eisen dat aan deze normen wordt voldaan. Operationale overeenkomsten zijn een soort van Service Level Agreement (SLA). Een operationele overeenkomst kan daarnaast ook op andere operationele afspraken betrekking hebben, bijvoorbeeld:<br/>
